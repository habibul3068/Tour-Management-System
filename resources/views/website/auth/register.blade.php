                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control glass-input form-select" name="course_id">
                                ...
                                <option value="web">Diploma in Web Application Development</option>
                                <option value="ict">Diploma in ICT</option>
                                <option value="tourism">Diploma in Tourism & Hospitality</option>
                            </select>
                        </div>
                    </div>
